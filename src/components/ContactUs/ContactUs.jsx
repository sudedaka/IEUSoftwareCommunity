...
const ContactUs = () => {
  return (
    <section id="contact-us" className="py-28 bg-white">
      <motion.div
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14 md:gap-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-6 py-3">
              ...
              <a href="mailto:softwareclubieu@hotmail.com">
                <FaEnvelope className="cursor-pointer hover:text-[#f08127] hover:scale-105 duration-200" size={18} />
              </a>
